...
// --- 任务配置表 (新增番剧只需在此添加一行) ---
const TASKS = [
  { name: "無限ガチャ", url: "https://anime.nicovideo.jp/detail/mugengacha/index.html",replace:["信じていた仲間達にダンジョン奥地で殺されかけたがギフト『無限ガチャ』でレベル9999の仲間達を手に入れて元パーティーメンバーと世界に復讐＆『ざまぁ！』します！", "無限ガチャ"] },
  { name: "嘆きの亡霊は引退したい 第2クール", url: "https://anime.nicovideo.jp/detail/nageki-anime2/index.html" },
]
